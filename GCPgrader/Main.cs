...
namespace GCPProjectGrader
{
    class Run
    {
        ...
        {
            //var trace = "trace";
            //var tempCredentialsFilePath = @"C:\Users\developer\Documents\GCPauth.json";
            ...
            var returnCode = autoRun.Execute(new string[]{
                "/test:GCPProjectGrader",
                "--work=" + tempDir,
                "--output=" + tempDir,
                "--err=" + tempDir,
                "--params:GCPCredentialsPath=" + tempCredentialsFilePath + ";trace=" + trace
